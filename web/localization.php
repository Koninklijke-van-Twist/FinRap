...
const TRANSLATIONS = [
    'nl' => [
        ...
        'report.tooltip.installments_received' => 'Som van ontvangen bedragen uit klantposten gekoppeld aan het project (Amount_LCY - Remaining_Amt_LCY). Incl. BTW.',
    ...
    'en' => [
        ...
        'report.tooltip.installments_received' => 'Sum of received amounts from customer ledger entries linked to the project (Amount_LCY - Remaining_Amt_LCY). Incl. VAT.',
    ...
    'de' => [
        ...
        'report.tooltip.installments_received' => 'Summe der erhaltenen Beträge aus Debitorenposten zum Projekt (Amount_LCY - Remaining_Amt_LCY). Inkl. MwSt.',
    ...
    'fr' => [
        ...
        'report.tooltip.installments_received' => 'Somme des montants reçus des écritures client liées au projet (Amount_LCY - Remaining_Amt_LCY). TTC.',

...
const TRANSLATIONS = [
    'nl' => [
        ...
        'error.report_overrides_locked' => 'Dit is niet het meest recente rapport. EAC- en POC PM-wijzigingen zijn alleen toegestaan op het nieuwste rapport.',
        ...
        'report.modal.poc_pm_title' => 'POC PM invoeren',
        'report.modal.eac_title' => 'EAC invoeren',
        'report.modal.value_label' => 'Waarde',
        'report.overrides.read_only_notice' => 'Dit is een ouder rapport. EAC- en POC PM-waarden zijn alleen-lezen; wijzigingen zijn alleen mogelijk op het meest recente rapport.',
        ...
        'report.tooltip.exp.poc_pm' => 'Tijdelijke POC-waarde van de projectmanager',
        'report.tooltip.exp.poc_calc' => 'Geboekte kosten gedeeld door EAC, als percentage',
    ...
    'en' => [
        ...
        'error.report_overrides_locked' => 'This is not the most recent report. EAC and POC PM changes are only allowed on the latest report.',
        ...
        'report.modal.poc_pm_title' => 'Enter POC PM',
        'report.modal.eac_title' => 'Enter EAC',
        'report.modal.value_label' => 'Value',
        'report.overrides.read_only_notice' => 'This is an older report. EAC and POC PM values are read-only; changes are only possible on the most recent report.',
        ...
        'report.tooltip.exp.poc_pm' => 'Temporary POC value from the project manager',
        'report.tooltip.exp.poc_calc' => 'Booked cost divided by EAC, as a percentage',
    ...
    'de' => [
        ...
        'error.report_overrides_locked' => 'Dies ist nicht der neueste Bericht. EAC- und POC PM-Änderungen sind nur im aktuellsten Bericht erlaubt.',
        ...
        'report.modal.poc_pm_title' => 'POC PM eingeben',
        'report.modal.eac_title' => 'EAC eingeben',
        'report.modal.value_label' => 'Wert',
        'report.overrides.read_only_notice' => 'Dies ist ein älterer Bericht. EAC- und POC PM-Werte sind schreibgeschützt; Änderungen sind nur im neuesten Bericht möglich.',
        ...
        'report.tooltip.exp.poc_pm' => 'Vorübergehender POC-Wert des Projektleiters',
        'report.tooltip.exp.poc_calc' => 'Gebuchte Kosten geteilt durch EAC, als Prozentsatz',
    ...
    'fr' => [
        ...
        'error.report_overrides_locked' => 'Ce n\'est pas le rapport le plus récent. Les modifications EAC et POC PM ne sont autorisées que sur le dernier rapport.',
        ...
        'report.modal.poc_pm_title' => 'Saisir POC PM',
        'report.modal.eac_title' => 'Saisir EAC',
        'report.modal.value_label' => 'Valeur',
        'report.overrides.read_only_notice' => 'Il s\'agit d\'un rapport plus ancien. Les valeurs EAC et POC PM sont en lecture seule ; les modifications ne sont possibles que sur le rapport le plus récent.',
        ...
        'report.tooltip.exp.poc_pm' => 'Valeur POC temporaire du chef de projet',
        'report.tooltip.exp.poc_calc' => 'Coût comptabilisé divisé par EAC, en pourcentage',

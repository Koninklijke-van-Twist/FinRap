...
const TRANSLATIONS = [
    'nl' => [
        ...
        'index.js.dashboard_chart_poc_baseline' => 'POC Baseline Kosten',
        'index.js.dashboard_chart_poc_eac' => 'POC EAC Kosten',
        'index.js.dashboard_chart_poc_baseline_hours' => 'POC Baseline Uren',
        'index.js.dashboard_chart_poc_eac_hours' => 'POC EAC Uren',
        ...
        'report.eac_gross_profit' => 'EAC Brutowinst',
        ...
        'report.tooltip.contract_value' => 'Som van Line_Amount_LCY uit FactureerbareProjectPlanningsRegels voor factureerbare regels met Type = GB-rekening / G/L Account en No = 800000 (zonder meerwerk). Excl. BTW.',
        ...
        'report.tooltip.total_budget_revenue' => 'Total_Price_LCY uit JobBaselineLines op totaalregel 000 (Type = GB-rekening / G/L Account, No = 800000). Excl. BTW.',
        'report.tooltip.gross_profit' => 'Contractwaarde minus VC Kosten',
        'report.tooltip.eac_gross_profit' => 'Contractwaarde minus EAC Kosten',
        ...
        'report.tooltip.installments_invoiced' => 'Som van Invoiced_Amount_LCY uit FactureerbareProjectPlanningsRegels voor factureerbare regels met Type = GB-rekening / G/L Account en No = 800000 (PRJ-regel: zonder LVS_Job_Change_Order_No). Excl. BTW.',
        'report.tooltip.installments_received' => 'Som van ontvangen bedragen excl. BTW uit klantposten gekoppeld aan het project: Sales_LCY × (Amount_LCY − Remaining_Amt_LCY) / Amount_LCY. Sales_LCY is excl. BTW; Amount_LCY en Remaining_Amt_LCY zijn incl. BTW. Open facturen tellen als 0.',
        ...
        'report.col.budget_hours' => 'VC Uren',
        'report.col.budget_revenue' => 'VC Opbrengsten',
        'report.budget_revenue.why_title' => 'Waarom zie ik deze kolom?',
        'report.budget_revenue.why_body' => 'De kolom "VC Opbrengsten" wordt enkel getoond wanneer er een verschil is tussen de regels van de contractwaarde en de voorgecalculeerde opbrengsten. Meestal komt dit omdat een suborder nog geen voorcalculatie heeft.',
        'report.budget_revenue.why_close' => 'Sluiten',
        'report.budget_revenue.why_aria' => 'Uitleg over de kolom VC Opbrengsten',
        'report.col.eac_hours' => 'EAC Uren',
        ...
        'report.tooltip.col.budget_hours' => 'Voorcalculatie-uren (JobBaselineLines.Quantity) voor Resource/Person met eenheid HR, gekoppeld via Job_Task_No',
        'report.tooltip.col.budget_revenue' => 'Total_Price_LCY uit JobBaselineLines wanneer Type = GB-rekening / G/L Account en No = 800000. Excl. BTW.',
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY uit FactureerbareProjectPlanningsRegels voor deze kostengroep wanneer Type = GB-rekening / G/L Account en No = 800000 (incl. meerwerk). Excl. BTW.',
        'report.tooltip.col.eac_hours' => 'Estimate At Completion uren (KVT_EAC_Hours_Quantity) uit ProjectTaken voor deze kostengroep',
        ...
        'report.hours.estimated' => 'EAC uren',
        ...
        'report.tooltip.hours.estimated' => 'EAC-uren (KVT_EAC_Hours_Quantity) uit ProjectTaken',
        'report.tooltip.hours.booked' => 'Werkelijk geboekt aantal uren tot nu toe',
        'report.tooltip.hours.to_go' => 'EAC-uren minus geboekte uren',
        ...
        'report.exp.poc_baseline' => 'POC Baseline Kosten',
        'report.exp.poc_baseline_hours' => 'POC Baseline Uren',
        'report.exp.poc_eac' => 'POC EAC Kosten',
        'report.exp.poc_eac_hours' => 'POC EAC Uren',
        'report.exp.work_in_progress_profit' => 'Onderhanden Winst',
        'report.modal.temp_notice' => 'Let op: Deze waarde wordt binnenkort in BC bijgehouden. Invoer op deze pagina is tijdelijk.',
        'report.modal.eac_title' => 'EAC Kosten invoeren',
        'report.modal.eac_hours_title' => 'EAC Uren invoeren',
    ...
    'en' => [
        ...
        'index.js.dashboard_chart_poc_baseline' => 'POC Baseline Costs',
        'index.js.dashboard_chart_poc_eac' => 'POC EAC Costs',
        'index.js.dashboard_chart_poc_baseline_hours' => 'POC Baseline Hours',
        'index.js.dashboard_chart_poc_eac_hours' => 'POC EAC Hours',
        'index.js.dashboard_chart_y_axis' => 'POC (%)',
        ...
        'report.eac_gross_profit' => 'EAC gross profit',
        ...
        'report.tooltip.contract_value' => 'Sum of Line_Amount_LCY from FactureerbareProjectPlanningsRegels for billable lines with Type = GB-rekening / G/L Account and No = 800000 (excluding change orders). Excl. VAT.',
        ...
        'report.tooltip.total_budget_revenue' => 'Total_Price_LCY from JobBaselineLines on total row 000 (Type = GB-rekening / G/L Account, No = 800000). Excl. VAT.',
        'report.tooltip.gross_profit' => 'Contract value minus PC Costs',
        'report.tooltip.eac_gross_profit' => 'Contract value minus EAC Costs',
        ...
        'report.tooltip.installments_invoiced' => 'Sum of Invoiced_Amount_LCY from FactureerbareProjectPlanningsRegels for billable lines with Type = GB-rekening / G/L Account and No = 800000 (PRJ row: without LVS_Job_Change_Order_No). Excl. VAT.',
        'report.tooltip.installments_received' => 'Sum of received amounts excl. VAT from customer ledger entries linked to the project: Sales_LCY × (Amount_LCY − Remaining_Amt_LCY) / Amount_LCY. Sales_LCY is excl. VAT; Amount_LCY and Remaining_Amt_LCY are incl. VAT. Open invoices count as 0.',
        ...
        'report.col.budget_hours' => 'PC Hours',
        'report.col.budget_revenue' => 'PC Revenue',
        'report.budget_revenue.why_title' => 'Why do I see this column?',
        'report.budget_revenue.why_body' => 'The "PC Revenue" column is only shown when there is a difference between the contract value lines and the pre-calculated revenue. This usually happens because a sub-order does not yet have a pre-calculation.',
        'report.budget_revenue.why_close' => 'Close',
        'report.budget_revenue.why_aria' => 'Explanation of the PC Revenue column',
        'report.col.eac_hours' => 'EAC Hours',
        ...
        'report.tooltip.col.budget_hours' => 'Pre-calculation hours (JobBaselineLines.Quantity) for Resource/Person with UoM HR, linked via Job_Task_No',
        'report.tooltip.col.budget_revenue' => 'Total_Price_LCY from JobBaselineLines when Type = GB-rekening / G/L Account and No = 800000. Excl. VAT.',
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY from FactureerbareProjectPlanningsRegels for this cost group when Type = GB-rekening / G/L Account and No = 800000 (incl. change orders). Excl. VAT.',
        'report.tooltip.col.eac_hours' => 'Estimate At Completion hours (KVT_EAC_Hours_Quantity) from ProjectTaken for this cost group',
        ...
        'report.hours.estimated' => 'EAC hours',
        ...
        'report.tooltip.hours.estimated' => 'EAC hours (KVT_EAC_Hours_Quantity) from ProjectTaken',
        'report.tooltip.hours.booked' => 'Actual booked hours to date',
        'report.tooltip.hours.to_go' => 'EAC hours minus booked hours',
        ...
        'report.exp.poc_baseline' => 'POC Baseline Costs',
        'report.exp.poc_baseline_hours' => 'POC Baseline Hours',
        'report.exp.poc_eac' => 'POC EAC Costs',
        'report.exp.poc_eac_hours' => 'POC EAC Hours',
        'report.exp.work_in_progress_profit' => 'Work in progress profit',
        'report.modal.temp_notice' => 'Note: This value will soon be maintained in BC. Entry on this page is temporary.',
        'report.modal.eac_title' => 'Enter EAC Costs',
        'report.modal.eac_hours_title' => 'Enter EAC Hours',
    ...
    'de' => [
        ...
        'index.js.dashboard_chart_poc_baseline' => 'POC Baseline Kosten',
        'index.js.dashboard_chart_poc_eac' => 'POC EAC Kosten',
        'index.js.dashboard_chart_poc_baseline_hours' => 'POC Baseline Stunden',
        'index.js.dashboard_chart_poc_eac_hours' => 'POC EAC Stunden',
        'index.js.dashboard_chart_y_axis' => 'POC (%)',
        ...
        'report.eac_gross_profit' => 'EAC Bruttogewinn',
        ...
        'report.tooltip.contract_value' => 'Summe von Line_Amount_LCY aus FactureerbareProjectPlanningsRegels für fakturierbare Zeilen mit Type = GB-rekening / G/L Account und No = 800000 (ohne Nachträge). Exkl. MwSt.',
        ...
        'report.tooltip.total_budget_revenue' => 'Total_Price_LCY aus JobBaselineLines auf Gesamtzeile 000 (Type = GB-rekening / G/L Account, No = 800000). Exkl. MwSt.',
        'report.tooltip.gross_profit' => 'Vertragswert minus VK Kosten',
        'report.tooltip.eac_gross_profit' => 'Vertragswert minus EAC Kosten',
        ...
        'report.tooltip.installments_invoiced' => 'Summe von Invoiced_Amount_LCY aus FactureerbareProjectPlanningsRegels für fakturierbare Zeilen mit Type = GB-rekening / G/L Account und No = 800000 (PRJ-Zeile: ohne LVS_Job_Change_Order_No). Exkl. MwSt.',
        'report.tooltip.installments_received' => 'Summe der erhaltenen Beträge exkl. MwSt. aus Debitorenposten zum Projekt: Sales_LCY × (Amount_LCY − Remaining_Amt_LCY) / Amount_LCY. Sales_LCY ist exkl. MwSt.; Amount_LCY und Remaining_Amt_LCY sind inkl. MwSt. Offene Rechnungen zählen als 0.',
        ...
        'report.col.budget_hours' => 'VK Stunden',
        'report.col.budget_revenue' => 'VK Erlöse',
        'report.budget_revenue.why_title' => 'Warum sehe ich diese Spalte?',
        'report.budget_revenue.why_body' => 'Die Spalte „VK Erlöse“ wird nur angezeigt, wenn es einen Unterschied zwischen den Vertragswertzeilen und den vorkalkulierten Erlösen gibt. Meistens liegt das daran, dass für einen Unterauftrag noch keine Vorkalkulation vorliegt.',
        'report.budget_revenue.why_close' => 'Schließen',
        'report.budget_revenue.why_aria' => 'Erklärung zur Spalte VK Erlöse',
        'report.col.eac_hours' => 'EAC Stunden',
        'report.col.eac' => 'EAC Kosten',
        ...
        'report.tooltip.col.budget_hours' => 'Vorkalkulationsstunden (JobBaselineLines.Quantity) für Resource/Person mit Einheit HR, verknüpft über Job_Task_No',
        'report.tooltip.col.budget_revenue' => 'Total_Price_LCY aus JobBaselineLines wenn Type = GB-rekening / G/L Account und No = 800000. Exkl. MwSt.',
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY aus FactureerbareProjectPlanningsRegels für diese Kostengruppe wenn Type = GB-rekening / G/L Account und No = 800000 (inkl. Nachträge). Exkl. MwSt.',
        'report.tooltip.col.eac_hours' => 'Estimate At Completion Stunden (KVT_EAC_Hours_Quantity) aus ProjectTaken für diese Kostengruppe',
        ...
        'report.hours.estimated' => 'EAC Stunden',
        ...
        'report.tooltip.hours.estimated' => 'EAC-Stunden (KVT_EAC_Hours_Quantity) aus ProjectTaken',
        'report.tooltip.hours.booked' => 'Tatsächlich gebuchte Stunden bis heute',
        'report.tooltip.hours.to_go' => 'EAC-Stunden minus gebuchte Stunden',
        ...
        'report.exp.poc_baseline' => 'POC Baseline Kosten',
        'report.exp.poc_baseline_hours' => 'POC Baseline Stunden',
        'report.exp.poc_eac' => 'POC EAC Kosten',
        'report.exp.poc_eac_hours' => 'POC EAC Stunden',
        'report.exp.work_in_progress_profit' => 'Gewinn aus laufender Arbeit',
        ...
        'report.modal.eac_title' => 'EAC Kosten eingeben',
        'report.modal.eac_hours_title' => 'EAC Stunden eingeben',
    ...
    'fr' => [
        ...
        'index.js.dashboard_chart_poc_baseline' => 'POC Baseline Coûts',
        'index.js.dashboard_chart_poc_eac' => 'POC EAC Coûts',
        'index.js.dashboard_chart_poc_baseline_hours' => 'POC Baseline Heures',
        'index.js.dashboard_chart_poc_eac_hours' => 'POC EAC Heures',
        'index.js.dashboard_chart_y_axis' => 'POC (%)',
        ...
        'report.eac_gross_profit' => 'Marge brute EAC',
        ...
        'report.tooltip.contract_value' => 'Somme de Line_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour les lignes facturables avec Type = GB-rekening / G/L Account et No = 800000 (hors avenants). HT.',
        ...
        'report.tooltip.total_budget_revenue' => 'Total_Price_LCY depuis JobBaselineLines sur la ligne totale 000 (Type = GB-rekening / G/L Account, No = 800000). HT.',
        'report.tooltip.gross_profit' => 'Valeur du contrat moins Coûts VC',
        'report.tooltip.eac_gross_profit' => 'Valeur du contrat moins Coûts EAC',
        ...
        'report.tooltip.installments_invoiced' => 'Somme de Invoiced_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour les lignes facturables avec Type = GB-rekening / G/L Account et No = 800000 (ligne PRJ : sans LVS_Job_Change_Order_No). HT.',
        'report.tooltip.installments_received' => 'Somme des montants reçus HT des écritures client liées au projet : Sales_LCY × (Amount_LCY − Remaining_Amt_LCY) / Amount_LCY. Sales_LCY est HT ; Amount_LCY et Remaining_Amt_LCY sont TTC. Les factures ouvertes comptent pour 0.',
        ...
        'report.col.budget_hours' => 'Heures VC',
        'report.col.budget_revenue' => 'Revenus VC',
        'report.budget_revenue.why_title' => 'Pourquoi vois-je cette colonne ?',
        'report.budget_revenue.why_body' => 'La colonne « Revenus VC » n’est affichée que lorsqu’il y a une différence entre les lignes de la valeur du contrat et les revenus précalculés. Cela vient généralement du fait qu’une sous-commande n’a pas encore de précalcul.',
        'report.budget_revenue.why_close' => 'Fermer',
        'report.budget_revenue.why_aria' => 'Explication de la colonne Revenus VC',
        'report.col.eac_hours' => 'Heures EAC',
        ...
        'report.tooltip.col.budget_hours' => 'Heures de précalcul (JobBaselineLines.Quantity) pour Resource/Person avec unité HR, liées via Job_Task_No',
        'report.tooltip.col.budget_revenue' => 'Total_Price_LCY depuis JobBaselineLines lorsque Type = GB-rekening / G/L Account et No = 800000. HT.',
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour ce groupe de coûts lorsque Type = GB-rekening / G/L Account et No = 800000 (avenants inclus). HT.',
        'report.tooltip.col.eac_hours' => 'Heures Estimate At Completion (KVT_EAC_Hours_Quantity) depuis ProjectTaken pour ce groupe de coûts',
        ...
        'report.hours.estimated' => 'Heures EAC',
        ...
        'report.tooltip.hours.estimated' => 'Heures EAC (KVT_EAC_Hours_Quantity) depuis ProjectTaken',
        'report.tooltip.hours.booked' => 'Heures réellement comptabilisées à ce jour',
        'report.tooltip.hours.to_go' => 'Heures EAC moins heures comptabilisées',
        ...
        'report.exp.poc_baseline' => 'POC Baseline Coûts',
        'report.exp.poc_baseline_hours' => 'POC Baseline Heures',
        'report.exp.poc_eac' => 'POC EAC Coûts',
        'report.exp.poc_eac_hours' => 'POC EAC Heures',
        'report.exp.work_in_progress_profit' => 'Bénéfice en cours',
        'report.modal.temp_notice' => 'Attention : cette valeur sera bientôt gérée dans BC. La saisie sur cette page est temporaire.',
        'report.modal.eac_title' => 'Saisir les coûts EAC',
        'report.modal.eac_hours_title' => 'Saisir les heures EAC',

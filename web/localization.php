...
const TRANSLATIONS = [
    'nl' => [
        ...
        'report.total_direct_cost' => 'Basislijn VC',
        ...
        'report.tooltip.total_direct_cost' => 'Totale voorcalculatie-kosten uit de projectbasislijn',
        ...
        'report.tooltip.installments_received' => 'Som van ontvangen bedragen uit klantposten gekoppeld aan het project (Amount_LCY - Remaining_Amt_LCY)',
        'report.col.cost_group_code' => 'Kostengroepcode',
        'report.col.cost_group_description' => 'Kostengroep omschrijving',
        'report.col.budget_cost' => 'Basislijn VC',
        'report.col.eac' => 'EAC',
        ...
        'report.tooltip.col.budget_cost' => 'Voorcalculatie-kosten uit de basislijn voor deze kostengroep',
        ...
        'report.tooltip.exp.variance' => 'Verschil tussen basislijn voorcalculatie en EAC (Basislijn VC - EAC)',
    ...
    'en' => [
        ...
        'report.total_direct_cost' => 'Baseline PC',
        ...
        'report.tooltip.total_direct_cost' => 'Total pre-calculation costs from the project baseline',
        ...
        'report.tooltip.installments_received' => 'Sum of received amounts from customer ledger entries linked to the project (Amount_LCY - Remaining_Amt_LCY)',
        'report.col.cost_group_code' => 'Cost group code',
        'report.col.cost_group_description' => 'Cost group description',
        'report.col.budget_cost' => 'Baseline PC',
        'report.col.eac' => 'EAC',
        ...
        'report.tooltip.col.budget_cost' => 'Pre-calculation costs from the baseline for this cost group',
        ...
        'report.tooltip.exp.variance' => 'Difference between baseline pre-calculation and EAC (Baseline PC - EAC)',
    ...
    'de' => [
        ...
        'report.total_direct_cost' => 'Basislinie VK',
        ...
        'report.tooltip.total_direct_cost' => 'Gesamte Vorkalkulationskosten aus der Projektbasislinie',
        ...
        'report.tooltip.installments_received' => 'Summe der erhaltenen Beträge aus Debitorenposten zum Projekt (Amount_LCY - Remaining_Amt_LCY)',
        'report.col.cost_group_code' => 'Kostengruppencode',
        'report.col.cost_group_description' => 'Kostengruppenbeschreibung',
        'report.col.budget_cost' => 'Basislinie VK',
        'report.col.eac' => 'EAC',
        ...
        'report.tooltip.col.budget_cost' => 'Vorkalkulationskosten aus der Basislinie für diese Kostengruppe',
        ...
        'report.tooltip.exp.variance' => 'Unterschied zwischen Basislinie Vorkalkulation und EAC (Basislinie VK - EAC)',
    ...
    'fr' => [
        ...
        'report.total_direct_cost' => 'Base VC',
        ...
        'report.tooltip.total_direct_cost' => 'Coûts totaux de précalcul issus de la ligne de base du projet',
        ...
        'report.tooltip.installments_received' => 'Somme des montants reçus des écritures client liées au projet (Amount_LCY - Remaining_Amt_LCY)',
        'report.col.cost_group_code' => 'Code groupe de coûts',
        'report.col.cost_group_description' => 'Description groupe de coûts',
        'report.col.budget_cost' => 'Base VC',
        'report.col.eac' => 'EAC',
        ...
        'report.tooltip.col.budget_cost' => 'Coûts de précalcul issus de la ligne de base pour ce groupe de coûts',
        ...
        'report.tooltip.exp.variance' => 'Différence entre précalcul de base et EAC (Base VC - EAC)',

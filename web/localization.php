...
const TRANSLATIONS = [
    'nl' => [
        ...
        'report.tooltip.col.budget_revenue' => 'Voorcalculatie-opbrengsten (Line_Amount) uit JobBaselineLines voor deze kostengroep',
    ...
    'en' => [
        ...
        'report.tooltip.col.budget_revenue' => 'Pre-calculation revenue (Line_Amount) from JobBaselineLines for this cost group',
    ...
    'de' => [
        ...
        'report.tooltip.col.budget_revenue' => 'Vorkalkulationserlöse (Line_Amount) aus JobBaselineLines für diese Kostengruppe',
    ...
    'fr' => [
        ...
        'report.tooltip.col.budget_revenue' => 'Revenus de précalcul (Line_Amount) issus de JobBaselineLines pour ce groupe de coûts',

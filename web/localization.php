...
const TRANSLATIONS = [
    'nl' => [
        ...
        'report.tooltip.contract_value' => 'Som van Line_Amount_LCY uit FactureerbareProjectPlanningsRegels voor factureerbare regels met Type = G/L Account en No = 800000 (zonder meerwerk). Excl. BTW.',
        ...
        'report.tooltip.total_budget_revenue' => 'Total_Price_LCY uit JobBaselineLines op totaalregel 000 (Type = G/L Account, No = 800000). Excl. BTW.',
        ...
        'report.tooltip.installments_invoiced' => 'Som van Invoiced_Amount_LCY uit FactureerbareProjectPlanningsRegels voor factureerbare regels met Type = G/L Account en No = 800000 (PRJ-regel: zonder LVS_Job_Change_Order_No). Excl. BTW.',
        ...
        'report.tooltip.col.budget_revenue' => 'Total_Price_LCY uit JobBaselineLines wanneer Type = G/L Account en No = 800000. Excl. BTW.',
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY uit FactureerbareProjectPlanningsRegels voor deze kostengroep wanneer Type = G/L Account en No = 800000 (incl. meerwerk). Excl. BTW.',
        ...
        'report.termijn.description_2' => 'Omschrijving 2',
    ...
    'en' => [
        ...
        'report.tooltip.contract_value' => 'Sum of Line_Amount_LCY from FactureerbareProjectPlanningsRegels for billable lines with Type = G/L Account and No = 800000 (excluding change orders). Excl. VAT.',
        ...
        'report.tooltip.total_budget_revenue' => 'Total_Price_LCY from JobBaselineLines on total row 000 (Type = G/L Account, No = 800000). Excl. VAT.',
        ...
        'report.tooltip.installments_invoiced' => 'Sum of Invoiced_Amount_LCY from FactureerbareProjectPlanningsRegels for billable lines with Type = G/L Account and No = 800000 (PRJ row: without LVS_Job_Change_Order_No). Excl. VAT.',
        ...
        'report.tooltip.col.budget_revenue' => 'Total_Price_LCY from JobBaselineLines when Type = G/L Account and No = 800000. Excl. VAT.',
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY from FactureerbareProjectPlanningsRegels for this cost group when Type = G/L Account and No = 800000 (incl. change orders). Excl. VAT.',
        ...
        'report.termijn.description_2' => 'Description 2',
    ...
    'de' => [
        ...
        'report.tooltip.contract_value' => 'Summe von Line_Amount_LCY aus FactureerbareProjectPlanningsRegels für fakturierbare Zeilen mit Type = G/L Account und No = 800000 (ohne Nachträge). Exkl. MwSt.',
        ...
        'report.tooltip.total_budget_revenue' => 'Total_Price_LCY aus JobBaselineLines auf Gesamtzeile 000 (Type = G/L Account, No = 800000). Exkl. MwSt.',
        ...
        'report.tooltip.installments_invoiced' => 'Summe von Invoiced_Amount_LCY aus FactureerbareProjectPlanningsRegels für fakturierbare Zeilen mit Type = G/L Account und No = 800000 (PRJ-Zeile: ohne LVS_Job_Change_Order_No). Exkl. MwSt.',
        ...
        'report.tooltip.col.budget_revenue' => 'Total_Price_LCY aus JobBaselineLines wenn Type = G/L Account und No = 800000. Exkl. MwSt.',
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY aus FactureerbareProjectPlanningsRegels für diese Kostengruppe wenn Type = G/L Account und No = 800000 (inkl. Nachträge). Exkl. MwSt.',
        ...
        'report.termijn.description_2' => 'Beschreibung 2',
    ...
    'fr' => [
        ...
        'report.tooltip.contract_value' => 'Somme de Line_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour les lignes facturables avec Type = G/L Account et No = 800000 (hors avenants). HT.',
        ...
        'report.tooltip.total_budget_revenue' => 'Total_Price_LCY depuis JobBaselineLines sur la ligne totale 000 (Type = G/L Account, No = 800000). HT.',
        ...
        'report.tooltip.installments_invoiced' => 'Somme de Invoiced_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour les lignes facturables avec Type = G/L Account et No = 800000 (ligne PRJ : sans LVS_Job_Change_Order_No). HT.',
        ...
        'report.tooltip.col.budget_revenue' => 'Total_Price_LCY depuis JobBaselineLines lorsque Type = G/L Account et No = 800000. HT.',
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour ce groupe de coûts lorsque Type = G/L Account et No = 800000 (avenants inclus). HT.',

...
const TRANSLATIONS = [
    'nl' => [
        ...
        'report.tooltip.contract_value' => 'Som van Line_Amount_LCY uit FactureerbareProjectPlanningsRegels voor factureerbare regels met Type = GB-rekening en No = 800000 (zonder meerwerk). Excl. BTW.',
        ...
        'report.tooltip.installments_invoiced' => 'Som van Invoiced_Amount_LCY uit FactureerbareProjectPlanningsRegels voor factureerbare regels met Type = GB-rekening en No = 800000 (PRJ-regel: zonder LVS_Job_Change_Order_No). Excl. BTW.',
        ...
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY uit FactureerbareProjectPlanningsRegels voor deze kostengroep wanneer Type = GB-rekening en No = 800000 (incl. meerwerk). Excl. BTW.',
    ...
    'en' => [
        ...
        'report.tooltip.contract_value' => 'Sum of Line_Amount_LCY from FactureerbareProjectPlanningsRegels for billable lines with Type = GB-rekening and No = 800000 (excluding change orders). Excl. VAT.',
        ...
        'report.tooltip.installments_invoiced' => 'Sum of Invoiced_Amount_LCY from FactureerbareProjectPlanningsRegels for billable lines with Type = GB-rekening and No = 800000 (PRJ row: without LVS_Job_Change_Order_No). Excl. VAT.',
        ...
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY from FactureerbareProjectPlanningsRegels for this cost group when Type = GB-rekening and No = 800000 (incl. change orders). Excl. VAT.',
    ...
    'de' => [
        ...
        'report.tooltip.contract_value' => 'Summe von Line_Amount_LCY aus FactureerbareProjectPlanningsRegels für fakturierbare Zeilen mit Type = GB-rekening und No = 800000 (ohne Nachträge). Exkl. MwSt.',
        ...
        'report.tooltip.installments_invoiced' => 'Summe von Invoiced_Amount_LCY aus FactureerbareProjectPlanningsRegels für fakturierbare Zeilen mit Type = GB-rekening und No = 800000 (PRJ-Zeile: ohne LVS_Job_Change_Order_No). Exkl. MwSt.',
        ...
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY aus FactureerbareProjectPlanningsRegels für diese Kostengruppe wenn Type = GB-rekening und No = 800000 (inkl. Nachträge). Exkl. MwSt.',
    ...
    'fr' => [
        ...
        'report.tooltip.contract_value' => 'Somme de Line_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour les lignes facturables avec Type = GB-rekening et No = 800000 (hors avenants). HT.',
        ...
        'report.tooltip.installments_invoiced' => 'Somme de Invoiced_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour les lignes facturables avec Type = GB-rekening et No = 800000 (ligne PRJ : sans LVS_Job_Change_Order_No). HT.',
        ...
        'report.tooltip.col.contract_value' => 'Line_Amount_LCY depuis FactureerbareProjectPlanningsRegels pour ce groupe de coûts lorsque Type = GB-rekening et No = 800000 (avenants inclus). HT.',

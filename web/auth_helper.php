...
if (auth_mimir_enabled()) {
    ...
    if (!isset($baseUrl) || !is_string($baseUrl) || trim($baseUrl) === '') {
        // Bestaande URL-builders (finrap_data / ProjectFinanceService) hebben een host nodig
        // om een parseerbaar OData-pad te maken. odata_get_all stuurt dat pad naar Mímir.
